...
{ name: "Beer-braised Beef and Onions", cat: "Red Meat", time: ["3½","Hour"],
id: "203BBO",
ingredients: [[1,"Tablespoon","Kosher Salt","-more if needed-"],[1,"Tablespoon","Black Pepper","-more for garnish-"],[6,"Bay Leaves"],[2,"Teaspoons","Sweet Paprika","-more for garnish-"],[4, "Pounds","Beef Stew Meat","(Cut into 3/2-inch chunks)","-Boneless-"],[1,"Tablespoon","Butter","(Unsalted)"],[1,"Tablespoon","Extra-Virgin Olive Oil","-more if needed-"],[4,["Spanish Onions","Large Yellow Onions"],"(thinly sliced)"],[6,"Sprigs","Thyme","(Fresh)"],[4,"Sprigs","Parsley","(Fresh)","-+ chopped Parsley for garnish-"],[1,"Tablespoon","Tomato Paste"],[1,"Teaspoon","Coriander","(Ground)"],["¼","Teaspoon","Cinnamon","(Ground)"],[1,"Tablespoond","All-Purpose Flour"],[2,"Cups",["Beef Stock","Chicken Stock"]],[1,"Cup","Beer"]
...
{ name: "Pot Roast", cat: "Red Meat", time: [3,"Hours"],
ingredients: [[3,"Pound","Beef Chuck Roast","-Boneless-"],"Kosher Salt",["Black Pepper","(Ground)"],[3,"Tablespoons","Canola Oil"],[4,"Tablespoons","Butter"],[2,"Medium","Red Onions","(cut into quarters)"],[4,"Carrots","(cut into 2-inch pieces)","-peeled-"],[3,"Stalks","Celery","(cut into 2-inch pieces)"],[1,"Rutabaga","(cut into 12-16 pieces (a pound))","-peeled-"],[8,"Cremini Mushrooms","(halved)"],[2,"Parsnips","(cut into 2-inch pieces)","-peeled-"],[1,"Head","Garlic","-top cut off to expose cloves-"],["¾","Cup","Tomato Paste"],[2,"Bay Leaves"],[3,"Sprigs","Rosemary"],["3/2","Cups","Red Wine","-preferably carbernet-"],[4,"Cups","Beef Broth"]
],
steps: [
...
"Add tomato paste and cook, stirring frequently, until it darkens slightly, about 5 minutes.","Add bay leaves, rosemary and wine and cook, stirring occasionally, until liquid is reduced to a thick gravy consistency, 5 to 7 minutes.",
...
{ name: "Geraldine's Pot Roast", cat: "Red Meat", time: ["3½","Hours"],
ingredients: [
["4-5","Pound","Brisket"], "Salt", ["Black Pepper","(Ground)"], "All-Purpose Flour", [4,"Tablespoons","Olive Oil"], [2,"Cups","Onions", "(Diced)"], [5,"Cloves","Garlic","(Minced)"], [3,"Cups","Tomatoes","(Peeled, seeded, diced)"], [1,"Teaspoon","Oregano","(Dried)"], [2,"Cups","Red Wine"], ["1½","Cups","Beef Stock"], [1,"Cup","Green Olives","(Pitted & Chopped)"], ["1½","Teaspoons","Dijon Mustard"], [2,"Tablespoons","Tomato Paste"]
],
steps: [ "Season the brisket with salt and pepper and dust it with flour. In a large, heavy pot or Dutch oven with a tight lid, heat 3 tablespoons of the oil over high heat. Add the brisket and brown on all sides. Transfer the meat to a plate.",
...
{name: "Soy-Ginger Flank Steak", cat: "Red Meat", time: [45,"Minutes"],
ingredients: [["alt",[1,"Tablespoon","Vegetable Oil"],[1,"Tablespoon","Canola Oil"]],["1½","Tablespoons", "Ginger","(peeled, finely grated)"],[1,"Tablespoon","Garlic","(minced)"],
["alt",["⅔","Cup","Soy Sauce","(Low sodium)"],["and",["½","Cup","Soy Sauce"],[3,"Tablespoons","Water"] ] ]
,["½","Cup","Brown Sugar","(light or dark)","-lightly packed-"],["½","Teaspoon","Red Pepper Flakes","(Optional)"],["2.5-3.0"," Pound","Flank Steak"],["Black Pepper","(Ground)"],["Scallions","(thinly sliced)","-White & (Optionally) Light Green parts-"],["Lime Wedges","-For serving-"],["Rice","(Cooked)","-For serving-"]
],
steps: [
"Preheat the broiler.",
...
{name: "Ground Lamb Pulao", cat: "Red Meat", time: [45,"Minutes"],
ingredients: [
[2,"Cups","Basmati Rice"],["3/2","Pounds",["Lamb","Beef"],"(Ground)"],["alt",[1,"Teaspoon","Ghee"],["Butter","(Unsalted)"],"Extra-Virgin Olive Oil"],[4,"Garlic","(Cloves)","-Peeled and grated-"],[2,"Tablespoons","Ginger","(Grated, fresh)"],["3/2","Teaspoons","Garam Masala"],["1/2","Teaspoon","Red Chile Powder"],["1/2","Teaspoon","Black Pepper"],[2,"Teaspoons","Kosher Salt"],[3,"Tablespoons","Lime Juice"],["1/2","Teaspoon","Turmeric","(Ground)"],[1,"Bunch","Scallions","(Trimmed, thinly sliced)","-about 6-"],["1/4","Cup","Mint Leaves","(Fresh, loosely packed)"]
],
steps: [
...
"Cook for about 4 minutes, until chops are nicely browned, then turn and cook for about 3 minutes more, until firm to the touch. Transfer to a warm platter.","Put herb salad leaves in a shallow bowl and season lightly with salt. Toss leaves with half the dressing, just to coat. Place dressed salad on top of pork chops. Drizzle remaining dressing over the top, add shavings of Pecorino cheese (if using), and serve."
]
},
{name: "Skillet Braised Marinated Pork Chops", cat: "Red Meat", time: ["2¾","Hours"],
ingredients: [
[2,"Pork Chops","(Loin)"], [3,"Tablespoons","Soy Sauce"], [3,"Tablespoons",["Dry Vermouth","Dry Sherry"]], [1,"Clove","Garlic","(minced)"], [3,"Scallions","(chopped)"],["Pepper","(Ground)"],[1,"Tablespoon",["Peanut Oil","Vegetable Oil"]], ["1/2","Cup","White Wine","(dry)"], ["Salt","(Coarse)","-To taste-"]
],
steps: [
...
{name: "(Broiled) Grilled Veal Chops", cat: "Red Meat", time: ["2¾","Hours"],
ingredients: [
[6,"Tablespoons","Olive Oil"],[6,"Tablespoons",["Red Wine","Balsamac Wine"]],[2,"Sprigs","Rosemary", "(Chopped)"],["Pepper","(Ground)"],[6,"3lb","Veal Chops"],"Salt","Lemon Wedges",["Garlic","(optional)"]
],
steps: [
...
{name: "Grilled Veal with Pancetta, Fava Beans & Pear", cat: "Red Meat", time: ["1½","Hours"],
ingredients: [
[2,"Ounce",["Pancetta","Bacon"],"(chopped)"],["alt",[10,"Ounce","Pearl Onions","(Basket)"],[1,"Cup","Basket Pearl Onions","(frozen)"]],[1,"Teaspoon","Sugar"],[1,"Cup","Chicken Broth","-Canned, Unsalted-"],["alt",[1,"Cup","Fava Beans","(peeled)"],[1,"Cup","Lima Beans","(frozen)"]],[2,"Teaspoons","Arrowroot"],[6,"Tablespoons","Sweet Marsala"],[1,"Teaspoon","Marjorem","(Fresh, minced)"],["alt",[4,"6-oz","Veal Loin Chops","(thin-sliced)"],[4,"6-oz","T-bone Steaks"]]
],
steps: [
...
{name: "Veal Chops with Basil", cat: "Red Meat", time: [45,"Minutes"],
ingredients: [
[4,"Veal Chops"],["Flour","-For dredging-"],[2,"Tablespoons","Olive Oil"],[1,"Medium-size","Onion","(sliced)"],[1,"Clove","Garlic","(minced)"],[4,"Tablespoons","Prosciutto", "(chopped)"],["1/2","Cup","Basil Leaves","(Fresh)"],["1/4","Pound","Mushrooms","(sliced)"],["1/4-1/2","Cup","Dry White Wine"],["Salt","(Coarse)"],["Pepper","(Ground)"]
],
steps: [
...
{name: "Red Wine-Braised Chicken Thighs with Root Vegetables", cat: "Chicken", time: [80,"Minutes"],
ingredients: [
[8,"Medium","Chicken Thighs","(3lb)","-Bone-in, skin removed-"],[2,"Tablespoons","All-Purpose Flour"],["¾","Teaspoon","Kosher Salt","-plus more to taste-"],["½","Teaspoon","Black Pepper","(Ground, Fresh)","-Plus more to taste-"],[4,"Tablespoons","Olive Oil","(divided)"],[14,"Ounce","Pearl Onions","(peeled)","-Packaged, frozen, thawed and patted dry"],[2,"Cups", ["Carrots","Parsnips"], "(Peeled, diced)","-about 10 ounces-"],[2,"Cups",["Celery Root", "Rutabaga", "Turnip"],"-about 10 ounces-"],[3,"Cloves","Garlic","(minced)"],[1,"Tablespoon","Tomato Paste","-+ 1 teaspoon-"],[1,"Tablespoon","Thyme","(chopped)","-Fresh-"],["1½","Cups","Dry Red Wine","-Pinot Noir or Merlot for example-"],[2,"Cups","Chicken Broth","(Low-sodium)"],[1,"Bay Leaf"],[2,"Teaspoons","Red Wine Vinegar"],["Flat-Leaf Parsley","(for garnish (optional))"]
],
steps: [
...
{name: "Roasted Chicken Provencal", cat: "Chicken", time: [75,"Minutes"],
ingredients: [
["alt",[4,"Chicken Legs"],[8,"Chicken Thighs","(Bone-in, skin-on)"]],[2,"Teaspoons","Kosher Salt"],[1,"Teaspoon","Black Pepper","(freshly ground)"],["½-¾","Cup","All-Purpose Flour"],[3,"Tablespoons","Olive Oil"],[2,"Tablespoons","Herbes de Provence"],[1,"Lemons","(quartered)"],["8-10","Cloves","Garlic","(peeled)"],["4-6","Medium-size","Shallots","(peeled and halved)"],["1/3","Cup","Dry Vermouth"],[4,"Sprigs","Thyme","-For serving-"]
],
steps: [
...
{name: "Three Cup Chicken", cat: "Chicken", time: [30,"Minutes"],
ingredients: [
[3,"Tablespoons","Sesame Oil"],[1,"Ginger","(2-to-3-inch)","-Peeled and sliced into coins,  approximately 12-"],[12,"Cloves","Garlic","(peeled)"],[4,"Scallions","(trimmed and cut into 1-inch pieces)"],["alt",[3,"Dried Red Peppers"],[1,"Teaspoon","Red Pepper Flakes"]],[2,"Pounds", "Chicken Thighs","(boneless or bone-in)","-cut into bite-size pieces-"],[1,"Tablespoon",["Unrefined Sugar","Light Brown Sugar"]],["½","Cup","Rice Wine"],["1/4","Cup","Light Soy Sauce"],[2,"Cups","Basil Leaves","-preferrably Thai-"]
],
steps: [
...
{name: "Oven-Roasted Chicken Shawarma", cat: "Chicken", time: [45,"Minutes"],
ingredients: [
[2,"Lemons","(Juiced)"],["½","Cup","Olive Oil","-+ 1 tablespoon-"],[6,"Cloves","Garlic","(Peeled, smashed and minced)"],[1,"Teaspoon","Kosher Salt"],[2,"Teaspoons","Black Pepper","-Freshly ground-"],[2,"Teaspoons","Cumin","(Ground)"],[2,"Teaspoons","Paprika"],["½","Teaspoon","Turmeric"],[1,"Pinch","Cinnamon","(Ground)"],["Red Pepper Flakes","(For taste)"],[2,"Pounds","Chicken Thighs","(Boneless, skinless)"],[1,"Large","Red Onions","(peeled and quartered)"],[2,"Tablespoons","Parsley","(Chopped, fresh)"]
],
steps: [
...
"(Optional) To make the chicken even more crisp, set a large pan over high heat, add a tablespoon of olive oil to the pan, then the sliced chicken, and sauté until everything curls tight in the heat.","Scatter the Parsley over the top and serve with tomatoes, cucumbers, pita, white sauce, hot sauce, olives, fried eggplant, feta, rice (or really anything you want to)"
]
},
{name: "Vinegar Chicken with Crushed Olive Dressing", cat: "Chicken", time: [40,"Minutes"],
ingredients: [
["3½","Pounds","Chicken Parts","(Bone-in, skin-on)"],[1,"Teaspoon","Turmeric","(Ground)"],[6,"Tablespoons","Olive Oil"],"Kosher Salt",["Pepper","(Ground)"],["½","Cup","White Wine Vinegar"],["1½","Cups","Green Olives","(Crushed and pitted)","-Castelvetrano-"],[2,"Cloves","Garlic","(finely grated)"],[1,"Cup","Parsley","-Tender leaves and stems, chopped-"]
],
steps: [
...
{name: "Crispy Paremsan Roast Chicken with Lemon", cat: "Chicken", time: [75,"Minutes"],
ingredients: [
[1,"Small","Lemons"],[2,"Teaspoons","Kosher Salt","-Plus more to taste-"],[1,"Teaspoon","Black Pepper"],[1,"Teaspoon","Rosemary","(chopped)","-plus 4 sprigs-"],[1,"Large Pinch","Red Pepper Flakes","(Optionally)","-+More for serving-"],["3½-4","Pound","Whole Chicken","(patted dry)"],["Extra-Virgin Olive Oil","-for drizzling-"],["1/3","Cup","Parmesan","(finely grated)"]
],
steps: [
...
{name: "Bhatti Da Murgh (Indian Grilled Chicken with Whole Spices)", cat: "Chicken", time: ["1½","Hours"],
ingredients: [
[6,"Chicken Legs","(Whole, Bone-in, drumsticks with thighs attached)","-about 4½ pounds-"],[6,"Cloves","Garlic","(finely grated)","-about 2 tablespoons-"],[2,"Tablespoons","Ginger","(finely grated)"],[1,"Tablespoon","White Vinegar"],["1½","Teaspoons","Cayenne","(Ground)","-for to taste-"],["1½","Teaspoons","Garam Masala"],[2,"Teaspoons","Sea Salt","(Fine)"],["½","Cup","Plain Yogurt","-whole milk-"],["1½","Teaspoon","Black Pepper","(freshly ground)"],["½","Teaspoon","Clove","(Ground)"],["½","Teaspoon","Mace","(Ground)"],["½","Teaspoon",["Ground Anise","Fennel Seeds"]],["½","Teaspoon","Black Cardamom","(Ground)","-Optional-"],["½","Teaspoon","Green Cardamom","(Ground)"],[2,"Teaspoons","Cumin Seeds"],[2,"Teaspoons","Coriander Seeds"],["1½","Teaspoons","Red Pepper Flakes"],["3-4","Tablespoons","Melted Salted Butter","(as needed for basting)"],["Lime Wedges","(for serving)"]
],
steps: [
"Pop the joint on each leg: Grasp a drumstick in one hand and a thigh in the other, and bend the joint back until you hear a crack. (This helps the leg cook more evenly)","Using a small knife, make a slash in the meaty part of each drumstick and thigh 2-3 times, going all the way to the bone.",
...
"Cover and refrigerate chicken for at least 6 hours (preferably overnight).","When ready to cook, prepare the grill for indirect hear. For charcoal grills: Mound coals to one side, allowing for an area of indirect hear. For gas grills: Turn on only a few of the burners and leave the rest off. For ovens: Heat oven to 450 degrees.",
...
{name: "Sheet-Pan Miso Chicken with Radishes and Lime", cat: "Chicken", time: [45,"Minutes"],
ingredients: [
[4,"Chicken Thighs","(Bone-in, skin-on)","-About 1½ lb total-"],[2,"Tablespoons","Olive Oil"],"Kosher Salt","Black Pepper",["alt",[1,"Tablespoon","Ghee"],["Butter","(Unsalted)","-Room temperature-"]],["1½","Teaspoons","White Miso Paste"],[1,"Pound","Radishes","(trimmed)","-If large, halved-"],[1,"Lime","(cut in half)"],[2,"Scallions","(thinly sliced)","-Light green and white parts only-"],[["Black Sesame Seeds","White Sesame Seeds"],"-for sprinkling, optional-"]
],
steps: [
...
{name: "Cornish Game Hen (Glaze)", cat: "Chicken", time: [70,"Minutes"],
ingredients: [
[1,"Rock Cornish Hen"],["cat","[A] Apricot Glaze",["½","Cup","Apricot Jam"],[2,"Tablespoons","Soy Sauce"],[2,"Tablespoons","Dijon Mustard"],[2,"Tablespoons","Honey"]],["cat","[B] Asian Accent",[2,"Tablespoons","Soy Sauce"],[2,"Tablespoons","Chicken Broth"],[1,"Teaspoon","Sesame Oil"]],["cat","[C] Citrus Glaze",["1/4","Cup","Orange Juice Concentrate","(Frozen)","-Thawed-"],[2,"Tablespoons","Dijon Mustard"],[2,"Tablespoons","Honey"]],["cat","[D] Garlic-Herb",[2,"Tablespoons","Garlic","(finely chopped)","-fresh-"],[2,"Teaspoons","Thyme","(finely chopped)","-fresh-"],[2,"Teaspoons","Rosemary","(finely chopped)","-fresh-"]],["cat","[E] Lemon-Basil",[1,"Lemons"],["Butter","(melted)"],[1,"Sprig","Basil"]],["cat","[F] Mexican Spiced","Taco Seasoning","Cooking Spray"],["cat","[G] Mustward-Herb",[1,"Tablespoon","Dijon Mustard"],"Dried Tarragon","Basil","Thyme",["3/4","Cup","White Wine"]]
],
steps: [
...
{name: "Cornish Hens with Lemon & Sage", cat: "Chicken", time: [1,"Hours"],
ingredients: [
[2,"Cornish Hens"],[14,"Sage Leaves","-fresh-"],["½","Lemons"],[1,"Clove","Garlic","(minced)"],[2,"Tablespoons","Olive Oil"],["and",["Sea Salt","(Coarse)","-to taste-"],["Pepper","(Freshly ground)","-to taste-"]]
],
steps: [
...
{name: "Chicken and Rice with Scallion-Ginger Sauce", cat: "Chicken", time: [45,"Minutes"],
ingredients: [
["3/2","Cups","White Rice","(Short-grain)","-Preferrably sushi rice-"],[2,"Cups","Chicken Broth"],[1,"Piece","Ginger","(3-inch)","-peeled and grated (about 3 tablespoons)-"],[4,"Chicken Breasts","(boneless, skinless)","-totaling 2lb-"],"Kosher Salt","Kosher Pepper",["1/4","Cup","Vegetable Oil"],[6,"Scallions","(trimmed and thinly sliced)"],[2,"Tablespoons","Rice Vinegar","(unseasoned)"],[1,"Jalapeno","(halved, seeded, then thinly sliced)"],[2,"Teaspoons","White Sesame Seeds","toasted"],[1,"Teaspoon","Sesame Oil"],["1/2","Teaspoon","Granulated Sugar"]
],
steps: [
...
{name: "Ginger-Scallion Chicken", cat: "Chicken", time: [15,"Minutes"],
ingredients: [
[2,"Large","Scallions","(trimmed)"],["1/4","Cup",["Peanut Oil","Neutral Oil"],"(grapeseed or sunflower for example)","-more as necessary-"],["7/4","Pounds",["Chicken Thighs","Chicken Breasts"],"(boneless, skinless)","-cut into 1-inch chunks-"],["1/2","Teaspoon","Kosher Salt","-as needed-"],[1,"Cup","Cilantro","(Mixed leaves and tender stems)","-Roughly chopped-"],[1,"Piece","Ginger","(5/2-inch)","-cut into thin matchsticks (about 3 tablespoons)-"],[3,"Tablespoons","Soy Sauce"],["Sugar","(large pinch)"]
],
steps: [
...
{name: "Bake Rice with Chicken and Mushroom", cat: "Chicken", time: [80,"Minutes"],
ingredients: [
[2,"Pounds","Chicken Thighs","(skinless,boneless)","-cut into 2-inch chunks-"],"Salt","Pepper",[2,"Tablespoons","Olive Oil"],[1,"Large","Onion","(diced, about 3/2 cups)"],[1,"Sprig","Thyme","(large)","-plus 1 teaspoon freshly chopped leaves-"],[1,"Bay Leaf"],[1,"Cup","White Wine"],[2,"Cups","Basmati Rice","-soaked for 20 minutes, rinsed and drained-"],[8,"Ounces","King Trumpet Mushrooms","(Or a mixture of mushrooms)","-Sliced 1/4-inch thick-"],[4,"Cups","Chicken Broth","(hot)"],[3,"Tablespoons","Butter","(unsalted)"],[1,"Cup","Frozen Peas","(cooked for 2 minutes in salted water (optional))"],[2,"Cloves","Garlic","(small)","-smashed to a paste with a little salt-"],[3,"Tablespoons","Parsley","(Roughly chopped)"]
],
steps: [
...
{name: "Middle Eastern Herb and Garlic Chicken", cat: "Chicken", time: [40,"Minutes"],
ingredients: [
[6,"Chicken Thighs","(boneless, skinless)","-about 7/4 pounds-"],[6,"Cloves","Garlic","(grated on a Microplane or minced"],[2,"Lemons","-Juice and zest of-"],[3,"Tablespoons","Extra-Virgin Olive Oil","-more for serving-"],[2,"Tablespoons","Parsley","(minced, fresh)","-more for serving-"],[2,"Tablespoons","Mint","(minced, fresh)"],[1,"Tablespoon","Thyme","(minced, fresh)"],[1,"Tablespoon",["Oregano","Marjoram"],"(minced, fresh)"],["3/2","Teaspoons","Kosher Salt","(more as needed)"],[1,"Tablespoon","Sesame Seeds","-more for garnish (optional)-"],["3/4","Teaspoon","Sumac","(more for garnish (optional))"],["2/3","Cup","Plain Greek Yogurt","-preferably whole milk yogurt-"],["1/4","Teaspoon","Black Pepper","(ground)"]
],
steps: [
...
{name: "Miso Chicken in Ginger, Leek, & Scallion Broth", cat: "Chicken", time: [1,"Hours"],
ingredients: [
[8,"Chicken Thighs","(boneless, skinless)","-about 3lb-"],"Salt","Pepper",[2,"Cloves","Garlic","(large)","-smashed but not peeled, plus 1/2 teaspoon grated garlic-"],[1,"Piece","Ginger","(2-inch)","-peeled and thickly sliced, plus 1 teaspoon grated fresh ginger"],[1,"Small","Onion","(thinly sliced)"],[6,"Cups","Chicken Broth","(optional)"],["1/4","Cup","Mirin"],[4,"Tablespoons",["Yellow Miso","Red Miso"]],["1/2","Teaspoon","Gochugaru","(Korean red-pepper flakes)"],[2,"Tablespoons","Rice Wine Vinegar"],[2,"Tablespoons","Granulated Sugar"],[2,"Cups","Leeks","(white and tender green parts, chopped into 1/2-inch pieces)"],["1/2","Cup","Scallions","(thinly sliced)","-For garnish-"]
],
steps: [
...
"In a small bowl, combine miso, gochugaru, grated garlic, grated ginger, vinegar and sugar. Add a little hot broth to thin, then smear mixture over chicken and coat well.","Bake chicken until browned and glazed, about 20 minutes.",
...
{name: "Chicken Shawarma", cat: "Chicken", time: [3,"Hours"],
ingredients: [
[2,"Lemons","(about 6 tablespoons)","-Juice of-"],["1/2","Cup","Olive Oil","(+1 tablespoon)"],[6,"Cloves","Garlic","(minced)"],[1,"Teaspoon","Kosher Salt"],[2,"Teaspoons","Black Pepper","(Freshly ground)"],[2,"Teaspoons","Cumin","(ground)"],["½","Teaspoon","Turmeric","(ground)"],[1,"Pinch","Cinnamon","(ground)"],[2,"Teaspoons","Hot Paprika","-or, more to taste-"],["Red Pepper Flakes","(crushed)","-or more to taste-"],[2,"Pounds","Chicken Thighs","(boneless, skinless)"],[1,"Large","Red Onions","(about 10 ½oz)","-Peeled and cut into 6 wedges-"],[2,"Tablespoons","Parsley","(flat-leaf, chopped)","-optional-"],["cat","For Serving (Optional)",["alt","Pita Bread","Naan bread"],"Greek Salad",["and",["Cucumbers","(chopped)"],["Tomatoes","(chopped)"]],"Hummus",["Dip","-Yogurt and cucumber-"],"Kalamata Olives","Feta Cheese",["Eggplant","(roasted)"],["Rice","(cooked)"],["Couscous","-such as this Lemon Israeli Couscous-"],"Hot Sauce"]
],
steps: [
...
{name: "Chicken Florentine", cat: "Chicken", time: [35,"Minutes"],
ingredients: [
["3/2","Pound","Chicken Thighs","(skinned and boned)"],["1/4","Cup","Green Olive Oil"],[1,"Large","Garlic","(full bulb, chopped)"],[2,"Large","Onion","(chopped)"],[1,"Teaspoon","Rosemary"],["1/2","Cup","White Wine","(Italian)"],["alt",[1,"Pound","Spinach","(fresh, chopped)"],[1,"Package","Spinach","(frozen, chopped)"]],[1,"Cup","Parsley","Italian, fresh, chopped)"],["½","Lemons","(squeezed)"],["Black Pepper","-to taste-"],[2,"Cups","Water"],[1,"Cup","Rice","(long-grain)"]
],
steps: [
...
{name: "Chicken with Tarragon, Shallots, Vinegar", cat: "Chicken", time: [25,"Minutes"],
ingredients: [
[1,"Tablespoon","Tomato Paste"],[4,"Tablespoons","Parsley","(Fresh)"],[4,"Chicken Breasts","(about 5/4 pounds)"],"Salt","Pepper",[1,"Tablespoon","Olive Oil"],[3,"Tablespoons","Shallots"],[1,"Tablespoon","Garlic","(minced)"],[1,"Teaspoon","Tarragon"],["1/2","Cup","White Wine"],[4,"Ripe","Plum Tomatoes","(cut into cubes)"],[2,"Tablespoon","Red Wine Vinegar"],[4,"Tablespoons","Capers","(drained)"]
],
steps: [
"Sprinkle chicken with salt and pepper.",
"Heat oil in skillet.","Add chicken and sauté over medium heat for 5 minutes.",
...
{name: "Fippy Chicken", cat: "Chicken", time: [40,"Minutes"],
ingredients: [
["Oranges","Breadcrumbs","Chicken Breasts","Honey-Mustward","Soy Sauce","Orange Juice","Garlic Powder","Pepper","Tarragon","White Wine"]
],
steps: [
...
{name: "Roast Chicken with Garlic", cat: "Chicken", time: ["1½","Hours"],
ingredients: [
["7/4","Pound","Chicken","(roasting)"],[1,"Lemons","(cut in half)"],[1,"Garlic","(head, separated in cloves)"],["½","Cup","Water"],[2,"Tablespoons","Extra-Virgin Olive Oil"]
],
steps: [
...
{name: "Brined Chicken", cat: "Chicken", time: ["1¼","Hours"],
ingredients: [
["cat","Brine",["½","Cup","Kosher Salt"],["7/4","Cups","Sugar"],["1","Cup","Honey"],["and",["3 Sprigs"],"Parsley","Dill","Thyme","Tarragon","Sage"],[1,"Sprig","Rosemary"],[1,"Tablepsoon","Mustard Seeds"],[1,"Tablespoon","Fennel Seeds"],[1,"Cinnamon Stick"],[2,"Large","Bay Leaves"],[4,"Cloves"],["½","Tablespoon","Juniper Berries"],["½","Tablespoon","Cardamom Peas"],[1,"Tablespoon","Black Peppercorn"],[1,"Lemons","(halved and squeezed lightly)"],[3,"Star Anise"],["½","Tablespoon","Whole All Spice"]],["cat","Chicken",["7/4","Pound","Chicken"],[1,"Cup","Carrots","(sliced)"],[1,"Cup","Celery","(sliced)"],[1,"Cup","Onion","(sliced)"],[2,"Tablespoons","Butter","(unsalted, melted)"]]
],
steps: [
...
{name: "Nobu's Chicken Teriyaki", cat: "Chicken",
ingredients: [
[1,"Cup","Chicken Stock"],["1/2","Cup","Soy Sauce","-Japanese-"],[7,"Tablespoons","Sugar"],[1,"Tablespoon","Corn Starch"],[1,"Tablespoon","Water"],[2,"Chicken Breasts","(Whole, boneless, skinless)"],[2,"Tablespoons","Vegetable Oil"]
],
steps: [
"Bring the stock, soy sauce and sugar to a boil in a small saucepan. Lower the heat and simmer for 2 minutes. Mix together the cornstarch and the water and whisk into the teriyaki base. Bring back to a boil and simmer for 2 more minutes. Remove from the heat.","Prick holes in the chicken with the tines of a fork. Pour the sauce over the chicken breasts and marinate, turning occasionally, for 6 hours, or overnight.","Heat the grill. Scrape the excess sauce off the chicken and reserve. Brush the grill with oil. Grill the chicken for 5 minutes. Turn and baste with the sauce. Continue to turn and baste, using as much sauce as desired, until the juices run clear when pricked with a knife. About 12 to 15 minutes."
]
},
{name: "Peruvian Chicken", cat: "Chicken", time: [2,"Hours"],
ingredients: [
["3½","Pound","Whole Chicken","-Spatchcock recommended-"],[2,"Tablespoon",["Avocado Oil","Olive Oil"]],[2,"Tablespoon","Ajiamarillo Paste"],["3/2","Tablespoon","Lime Juice"],[3,"Cloves","Garlic","(large, pressed or minced)"],[2,"Teasponns","Kosher Salt"],[1,"Teaspoon","Cumin","(Ground)"],[1,"Teasponn","Oregano","(dried)"],[1,"Teaspoon","Black Pepper","(Freshly ground)"],["Cilantro Jalapeno Sauce","(for serving, optional)"]
],
steps: [
"While it's not required, I highly recommend you spatchcock the chicken. All this means is you cut the backbone out so it lays flat on the roasting pan. Spatchcock chicken cooks more evenly, more quickly, and is much easier to carve. My Spatchcock Chicken post shows you how do to this.","In a small bowl, mix together the avocado oil, aji amarillo paste, lime juice, garlic, salt, cumin, oregano, and black pepper.","Place the chicken on a sheet pan and pat the chicken dry with a paper towel. Then rub the marinade all over the chicken. Let sit at room temperature for one hour.","Alternatively, you can marinate this up to 24 hours in advance in the fridge. Note: never leave meat out of the fridge for more than 2 hours.","15 minutes before cooking, preheat the oven to 425F.","Roast the chicken for 40-45 minutes, basting the chicken in its own juices after 30 minutes, and again at 40 minutes. When the chicken is done, the breast should register at 160F when measured with a thermometer.","Let the chicken rest for 5-10 minutes after roasting, so the juices don't run out while carving. Enjoy!"
]
},
{name: "Chicken Breast w Mushrooms & Capers", cat: "Chicken",
ingredients: [
["4 Chicken Breasts (boneless, skinless)"],[" Around 3/2 Pounds"],["Salt And Freshly Ground Pepper For Taste"],["2 Tablespoons Olive Oil"],["1/2 Cup Onion (finely Chopped)"],["1 Teaspoon Garlic (finely Chopped)"],["1 Teaspoon Chopped Fresh Rosemary Or 1 Teaspoon Dried"],["1 Pound Small Mushrooms (if Large"],[" Cut In Quarters)"],["2 Tablespoons Red Wine Vinegar"],["4 Tablespoons Capers (drained)"],["1/2 Cup Chicken Broth (Fresh Or Canned)"],["1 Tablespoon Tomato Paste"],["4 Tablespoons Parsley (chopped)"]
],
steps: [
"Cut the chicken in lite-sized pieces. Sprinkle the chicken with salt, pepper and flour.","Heat the oil in a heavy-bottomed skillet. Add the chicken breasts. Sauté them over medium-high heat, turning often, until lightly browned, about 5 minutes.","Add the onion, garlic, rosemary and mushrooms. Cook stirring about 5 minutes.","Pour off the fat and add the vinegar, stirring to dissolve the brown particles clinging to the skillet. Add the capers, broth and tomato paste and blend well. Bring to a boil, cover and simmer 5 minutes. Add the Parsley and stir to coat the chicken well. Serve."
]
},
{name: "Chicken Skillet w Orzo, Dill, & Fetas", cat: "Chicken", time: [35,"Minutes"],
ingredients: [
[2,"Lemons"],[5,"Tablespoons","Olive Oil"],[3,"Cloves","Garlic","(Smashed)"],[1,"Teaspoon","Kosher Salt"],[1,"Teaspoon","Black Pepper"],["alt",[2,"Pounds","Chicken Drumsticks"],[2,"Pounds","Chicken Thighs","(bone-in)"]],[1,"Yellow Onion","(Peeled, chopped)"],[2,"Cups","Orzo"],[3,"Cups",["Chicken Broth","Water"]],["alt",[2,"Small","Cucumbers","(English, Thin-skinned)","-Chopped-"],[1,"Large","Cucumbers","(English, Thin-skinned)","-Chopped-"]],[5,"Ounces","Feta","(Crumbled)","-about 7/4 Cups-"],[2,"Tablespoons","Dill","(Fresh, Chopped)"],["Green Olives","(Castelvetrano Or Other Green Olives)","-For Serving-"]
],
steps: [
"Cut one of the lemons into wedges and set aside. Juice the remaining lemon and combine with 3 tablespoons olive oil, garlic, salt and pepper, in a large resealable plastic bag or in a bowl, along with the chicken pieces. Seal and shake the bag (or stir in the bowl) to coat. Set aside for 30 minutes, or refrigerate up to overnight.","Heat the remaining 2 tablespoons olive oil in a large cast-iron skillet over medium-high heat. Remove the chicken from the marinade, letting the excess drip off, and cook until lightly golden all over, turning when the chicken releases easily from the pan, about 12 minutes total. Transfer chicken to a plate and set aside.","Add the onion to the pan and stir to coat with the remaining fat. Decrease heat to medium and cook until soft, about 4 minutes. Stir in the orzo and the broth or water. Cook until the liquid is partly absorbed, stirring occasionally, about 5 minutes. Top with the chicken legs and cover with a lid or foil. Continue cooking until the orzo is tender, most of the liquid is absorbed, and the chicken is cooked through, 15 to 20 minutes more, depending on the size of your drumsticks or thighs. Remove from the heat and scatter the cucumber, feta and dill over the top. Serve from the skillet with lemon wedges and olives."
]
},
{name: "Halibut With Brown Butter, Lemon and Sage", cat: "Fish", time: [30,"Minutes"],
ingredients: [
["3/2~","Pounds","Halibut Fillets","(Cut Into 4 Pieces)","-Or other firm white-fleshed fish-"],"Salt","Black Pepper",[2,"Tablespoons","Olive Oil"],[4,"Tablespoons","Butter","(Unsalted)"],["12-15","Sage Leaves","(Fresh)"],[2,"Tablespoons","Lemon Juice","(Freshly squeezed)"],["1/4","Cup","Bread Crumbs","Coarse, Homemade","-Toasted"],[2,"Tablespoons","Parsley","(Finely chopped)"],["Lemon Wedges","(For Serving)"]
],
steps: [
"Season fish on both sides with plenty of salt and pepper.","Pour oil into a large, heavy skillet (preferably cast iron or nonstick) and set over medium-high heat. When oil is hot (but not smoking), swirl to evenly coat the pan, then add fish in a single layer. Let cook undisturbed for 3 to 4 minutes, until first side is nicely browned. Adjust the heat as needed to produce a steady sizzle and prevent scorching.","Flip and cook fish for about another 3 minutes, until just done. (To test for doneness, use a fork to gently probe the flesh: it should flake easily.) Transfer cooked fish to a warm platter or serving plates.","Make the sauce: Place skillet back on the stove over medium-high heat. Add butter and sage leaves. Cook butter, swirling the pan, until foamy and just beginning to brown, about 1 minute. Turn off heat and stir in lemon juice.","Spoon butter sauce and sage leaves over fish. Sprinkle with bread crumbs and parsley. Serve immediately, with lemon wedges."
]
},
{name: "Trout With Chive Butter", cat: "Fish", time: [10,"Minutes"],
ingredients: [
[4,"Trout","(whole)","-Butterflied-"],["Sea Salt","(Fine)","-To Taste-"],[1,"Clove","Garlic","(Finely grated Or minced)"],["1/2","Teaspoon",["Lemon Juice","Lime Juice"],"(+ more to taste)"],["1/8","Teaspoon","Black Pepper","(Ground)"],[4,"Tablespoons","Butter","(unsalted)","(Cubed and softened)"],[1,"Tablespoon","Chives","(minced)","-More for serving-"],["alt","Trout Roe","Salmon Roe","Capers"]
],
steps: [
"Heat the broiler. Place trout, skin side down, on a rimmed baking sheet. Sprinkle with salt.","In a mini food processor, or using a mortar and pestle or a bowl and a fork, stir together garlic, lemon juice, pepper and a pinch of salt. Add softened butter and chives and mash or process until well mixed.","Broil trout until just opaque, 2 to 5 minutes depending upon your broiler.","Drop spoonfuls of butter on top of the fish; it will melt immediately. Top with more chives and with roe or capers, and a little more lemon juice if you like."
]
},
{name: "Shrimp Scampi", cat: "Fish", time: [25,"Minutes"],
ingredients: [
[1,"Pound","Shrimp","(Large)","-Peeled and deveined-"],[3,"Tablespoons","Extra-Virgin Olive Oil"],[1,"Tablespoon","Lemon Zest","(Plus 1 Tablespoon Juice (from 1 Lemon))"],["1/2","Teaspoon","Red Pepper Flakes"],"Kosher Salt","Black Pepper",[4,"Cloves","Garlic","(Minced)"],[2,"Tablespoons","Butter","(Unsalted)"],[1,"Cup","Orzo"],["1/3","Cup","Dry White Wine"],[2,"Cups","Water","(Boiling)"],[2,"Cups",["Seafood Stock","Chicken Stock"]],[3,"Tablespoons","Parsley","(Finely chopped)"]
],
steps: [
"In a medium bowl, stir together shrimp, 1 tablespoon olive oil, lemon zest, red-pepper flakes, 1/2 teaspoon salt, 1/4 teaspoon pepper and half the garlic. Set aside to marinate. (This step can be done up to 1 hour in advance.)","Add butter, remaining olive oil and remaining garlic to a medium skillet set over medium heat. When the butter starts to bubble, add the orzo and 1/2 teaspoon salt and cook, stirring often, until the orzo is toasted, about 2 minutes, adjusting the heat as necessary to prevent the garlic from burning. Carefully add the wine — it will bubble — and stir until absorbed, about 1 minute. Stir in water, reduce heat to low, cover, and cook until orzo is al dente, about 12 minutes.","Add the shrimp in a snug, even layer on top of the orzo, cover, and cook until all the shrimp is pink and cooked through, 2 to 4 minutes. Remove from heat and let sit, covered, 2 minutes.","Sprinkle with parsley and lemon juice, season with salt and pepper, and serve immediately."
]
},
{name: "Roasted Salmon With Miso Rice and Ginger-Scallion Vinaigrette", cat: "Fish", time: [30,"Minutes"],
ingredients: [
["1/4","Cup",["White Miso","Sweet Miso"]],["3/2","Cups","Basmati Rice","-Or other long-grain rice-"],[4,"Salmon Fillets","(Skin-on)","-Each 6-ounce-"],[2,"Tablespoons","Extra-Virgin Olive Oil"],"Kosher Salt","Black Pepper",["1/4","Cup","Soy Sauce","-Low sodium-"],["1/4","Cup","Scallions","(Chopped)","-Plus more for garnish-"],["alt",[1,"Tablespoon","White Vinegar","(Distilled)"],[1,"Tablespoon","Rice Vinegar","(Unseasoned)"]],[1,"Tablespoon","Ginger","(Fresh, Minced)"],[4,"Cups","Cabbage","(Finely shredded, about 8 Ounzes)","-Greens like Napa Or Savoy"],["Sesame Oil","(Roasted)","-For Serving-"]
],
steps: [
"Heat oven to 425 degrees. In a medium saucepan, whisk miso with 2 1/4 cups water until dissolved. Stir in rice and bring to a boil. Cover, reduce heat to low and cook until all of the liquid is absorbed and rice is tender, about 15 minutes. Remove from heat and let stand for 5 minutes. Fluff rice with a fork (it will be a little sticky).","On a rimmed baking sheet, rub salmon all over with olive oil, season with salt and pepper and arrange skin-side up. Roast until fish is just opaque and cooked to medium, 8 to 10 minutes.","In a small bowl, combine soy sauce, scallions, vinegar and ginger, and season with salt and pepper.","Divide miso rice and cabbage among bowls. Top with salmon, ginger-scallion vinaigrette and sesame oil."
]
},
{name: "Salmon With Anchovy-Garlic Butter", cat: "Fish", time: [25,"Minutes"],
ingredients: [
[3,"Tablespoons","Butter","(Softened)","-Unsalted-"],[4,"Anchovy Fillets","(Minced)"],[1,"Clove","Garlic","(Minced (or 2 Small Ones))","Fat"],["1/2","Teaspoon","Kosher Salt","(Coarse)"],["Black Pepper","(Freshly Ground)"],[4,"Salmon Fillets","(Skin-on)","-Each 6-8 Ounce-"],[2,"Tablespoons","Drained Capers","(Patted dry)"],["1/2","Lemons"],["Parsley","(Freshly chopped)","-For Serving-"]
],
steps: [
"Heat oven to 400 degrees. In a small bowl, mash together butter, anchovies, garlic, salt and pepper.","In a large ovenproof skillet, melt about half the anchovy butter. Add fish, skin side down. Cook for 3 minutes over high heat to brown the skin, spooning some pan drippings over the top of the fish as it cooks. Add capers to bottom of pan and transfer to oven. Roast until fish is just cooked through, 8 to 10 minutes.","Remove pan from oven and add remaining anchovy butter to pan to melt. Place salmon on plates and spoon buttery pan sauce over the top. Squeeze the lemon half over the salmon and garnish with chopped parsley. Serve."
]
},
{name: "Salty-Sweet Barbecue Salmon and Broccoli", cat: "Fish", time: [30,"Minutes"],
ingredients: [
[1,"Pound","Broccoli Florets","(Cut Into 1-inch Pieces (about 8 Cups))"],[12,"Scallions","(Trimmed and halved crosswise)"],[1,"Piece","Ginger","(Fresh, Peeled and julienned (about 1 1/2 Tablespoons)","-(1-inch)-"],["1/4","Cup",["Safflower Oil","Canola Oil"]],"Kosher Salt","Black Pepper",[2,"Tablespoons","Yellow Onion","(Finely Chopped)"],[1,"Tablespoon","Garlic","(Minced)"],[1,"Teaspoon","Tomato Paste"],["alt",[3,"Tablespoons","Turbinado Sugar"],[2,"Tablespoons","Light Brown Sugar"]],[6,"Tablespoons","Oyster Sauce"],[2,"Tablespoons","Rice Vinegar","(Unseasoned)"],[1,"Tablespoon","Soy Sauce","(Low Sodium)"],[4,"Salmon Fillets","(Skin-on)","-Each 6-ounce-"],["Rice","(Steamed)","-For Serving-"]
],
steps: [
"Heat oven to 450 degrees. On a rimmed baking sheet, combine broccoli, scallions, ginger and 2 tablespoons oil. Season with salt and pepper, and toss to coat. Spread in an even layer and roast until softened, about 15 minutes.","While the broccoli mixture roasts, prepare the oyster barbecue sauce: In a small saucepan, heat the remaining 2 tablespoons oil over low. Add onion and garlic, and cook until softened, about 2 minutes. Add tomato paste and cook, stirring frequently, for 1 minute. Add sugar and cook, stirring, until sugar dissolves and the mixture darkens slightly, about 3 minutes. Stir in 1/2 cup water (be careful, as the mixture may splatter a little), then the oyster sauce, vinegar and soy sauce. Bring to a simmer. (The sugar may seize, but keep stirring; it will dissolve.) Cook, stirring, until sauce is thickened, about 5 minutes. Season generously with pepper. Remove 1/2 cup and set aside for passing at the table.","Stir the roasted broccoli. Season salmon with salt and arrange on top of the broccoli. Liberally brush salmon all over with half of the remaining oyster barbecue sauce in the saucepan. Roast until the vegetables are caramelized and the salmon is cooked through, 8 to 10 minutes, basting salmon after 5 minutes with the barbecue sauce.","Divide salmon and vegetables among plates. Serve with steamed rice and the reserved barbecue sauce."
]
},
{name: "Five-Ingredient Creamy Miso Pasta", cat: "Pasta", time: [20,"Minutes"],
ingredients: [
"Kosher Salt",["16","Ounces",["Spaghetti","Linguine","Bucatini"]],[6,"Tablespoons","Butter","(Unsalted)"],[3,"Tablespoons",["White Miso","Red Miso"]],[4,"Ounces","Parmesan","(Finely Grated)","-1 Packed Cup"],[["Kizami Nori","Furikake"],"(Or other thinly sliced seaweed snacks)","-For Garnish (Optional)-"]
],
steps: [
"Bring a large pot of salted water to a boil. Add the pasta and cook, stirring occasionally, until al dente. Reserve 1 1/2 cups pasta water, then drain the pasta.","Add the butter, miso and 1 1/4 cups pasta water to the pot and whisk over medium heat until miso breaks down and liquid is uniform, 1 to 2 minutes. Add the pasta and Parmesan and cook, stirring vigorously with tongs until cheese is melted and sauce emulsifies. (The key word here is “vigorously.” To achieve a silky smooth pasta instead of a gloppy one, put your cacio e pepe skills to work.)","Divide among shallow bowls and sprinkle with nori or furikake, if using."
]
},
{name: "Fast Spaghetti Bolognese", cat: "Pasta", time: [30,"Minutes"],
ingredients: [
"Kosher Salt","Black Pepper",[2,"Tablespoons","Olive Oil"],[1,"Medium","Yellow Onion","(Finely Chopped)"],[2,"Cloves","Garlic","(Finely Chopped)"],["1/2","Pound",["Ground Beef","Pork","Dark Meat Turkey"],"(Preferably 20 Percent Fat)"],[12,"Ounces",["Spaghetti","Pappardelle"],"(Or other long pasta)"],["1/4","Cup","Tomato Paste"],[2,"Teaspoons","Worcestershire Sauce"],["Parmesan","(Grated)","-For Serving-"]
],
steps: [
"Bring a large pot of salted water to a boil. Heat oil in a large skillet over medium-high. Add onion, garlic and 1/2 teaspoon salt and cook, stirring often, until beginning to soften, 3 minutes. Add beef and cook, breaking up with a wooden spoon, until no longer pink, about 3 minutes.","Add pasta to the pot and cook according to package instructions until al dente.","Meanwhile, add tomato paste to skillet and cook, stirring, until darkened, about 1 minute. Add 1 cup water, Worcestershire, 1/2 teaspoon pepper and 1/2 teaspoon salt and simmer until slightly reduced, about 5 minutes.","Using tongs, transfer pasta directly from the pot to the skillet along with 1 cup pasta water. Increase heat to high and simmer vigorously, tossing, until sauce reduces and coats the pasta, about 2 minutes. Season to taste with salt and pepper. Serve with Parmesan."
]
},
{name: "Mapo Ragù", cat: "Pasta", time: [1,"Hour"],
ingredients: [
[3,"Tablespoons","Neutral Oil","(Like Canola)"],[2,"Large","Onions","(Peeled and sliced)"],["Kosher Salt","(For taste)"],[1,"Pound","Pork","(Ground)"],[4,"Cloves","Garlic","(Peeled and chopped)"],["alt",["10-15","Rice Cakes","(Cylindrical,Frozen)","-Optional-"],"Rice Noodles","Pasta","Steamed Rice"],["Ginger","(Freshly peeled and chopped)","-1-inch-"],[3,"Tablespoons","Gochujang","(Korean Chili-bean Paste)"],[1,"Tablespoon","Soy Sauce","(Low-sodium)"],[1,"Tablespoon","Brown Sugar"],[2,"Teaspoons","Sichuan Peppercorns","(Optional)"],[1,"Bunch","Kale","(Roughly Chopped)","-Or Any Hearty Cooking Greens-"],[4,"Scallions","(Thinly sliced)","-For garnish-"]
],
steps: [
"Heat the oil in a wok set over medium-high heat. When it shimmers, add the onions and the pinch of salt. Cook, stirring occasionally, until the onions have released their moisture and are starting to brown, approximately 10 minutes. Then turn the heat down to low, and continue to cook, stirring every few minutes, until they have turned golden brown and sweet, an additional 20 minutes or so.","Tip the onions into a bowl, and return the wok to high heat over the stove. Add remaining tablespoon of oil, then the pork, and cook, breaking the meat up with a spoon, until it is just cooked, but not yet browning, approximately 10 minutes. Add the cooked meat to the reserved onions.","If using the rice cakes, put a large pot of salted water over high heat, and bring to a boil.","Return wok to stove over medium heat and cook the garlic and ginger in fat remaining from pork (add an extra splash of neutral oil if necessary). When the garlic and ginger soften, add gochujang, soy sauce, brown sugar and, if using, the Sichuan peppercorns. Add 1/2 cup to 1 cup of water, enough to loosen the gochujang and make a sauce, then return pork and onions to the wok and stir to combine. Adjust seasonings.","Bring sauce to a simmer, and add the chopped greens, then stir to combine and cook until they have started to soften, approximately 5 minutes.","If using rice cakes, place them in the boiling water for 3 to 5 minutes to soften, then drain and add to the sauce. (If not, serve the ragù with steamed rice, rice noodles or pasta.) Garnish with the sliced scallions."
]
},
{name: "Linguine with Clam Sauce", cat: "Pasta", time: [25,"Minutes"],
ingredients: [
"Kosher Salt",[1,"Pound","Linguine","(Or other long pasta, like Linguine Fini or Spaghetti)"],[1/4,"Cup","Extra-Virgin Olive Oil","(Plus more for serving (Optional))"],[5,"Cloves","Garlic","(Thinly Sliced)"],["½-1","Teaspoon","Red-Pepper Flakes"],["1/2","Teaspoon","Dried Oregano"],["1/2","Cup",["Vermouth","White Wine"],"(Dry)"],[2,"Cans","Clams","(Baby, Whole, With their juices)","-(10-ounce)-"],"Black Pepper",[2,"Tablespoons","Butter","(Unsalted)"],[2,"Teaspoons","Lemon Zest","(From 1-2 Lemons)"],["1/2","Cup","Parsley","(Italian, Chopped)"],["Lemon Wedges","(For Serving (Optional))"]
],
steps: [
...
{name: "Marcella Hazan’s Bolognese Sauce", cat: "Sauce", time: [4,"Hours"],
ingredients: [
[1,"Tablespoon","Vegetable Oil"],[3,"Tablespoons","Butter","(Plus 1 Tablespoon For Tossing The Pasta)"],["1/2","Cup","Onion","(Chopped)"],["2/3","Cup","Celery","(Chopped)"],["2/3","Cup","Carrots","(Chopped)"],["3/4","Pound","Beef Chuck","(Ground)","-Or You Can Use 1 Part Pork To 2 Parts Beef-"],"Salt",["Black Pepper","(Ground fresh from the mill)"],[1,"Cup","Whole Milk"],["Nutmeg","(Whole)"],[1,"Cup","White Wine","(Dry)"],["3/2","Cups","Canned Tomatoes","Cut Up, With Their Juice","-Imported Italian Plum-"],["1¼-1½","Pounds","Pasta"],["Cheese","(Freshly grated, Parmigiano-reggiano)","-At The Table-"]
],
steps: [
...
{name: "Sausage Ragù", cat: "Sauce", time: [2,"Hours"],
ingredients: [
[1,"Pound",["Sweet Italian Sausage","Bulk Sausage"]],"Extra-Virgin Olive Oil",[1,"Onion","(Minced)"],[1,"Carrots","(Minced)"],[1,"Celery","(Minced)","-Stalk-"],["1/4","Cup","Flat-Leaf Parsley","(Minced)","-Plus extra for garnish-"],[1,"Can","Tomatoes","(Whole, 28-ounce, With its juices)","-Preferably San Marzano-"],[1,"Sprig","Thyme","(Fresh, Large)"],[1,"Sprig","Rosemary","(Fresh, Large)"],[3,"Tablespoons","Tomato Paste"],"Salt",["Black Pepper","(Ground)"],[1,"Pound","Pasta","(Tubular, Dried)","-Pasta such as Mezzi Rigatoni, Paccheri, Penne-"],["Parmesan Cheese","(Freshly grated)","-For garnish (Optional)-"]
],
steps: [
...
{name: "Dijon and Cognac Beef Stew", cat: "Stew", time: [3,"Hours"],
ingredients: [
["1/4","Pound","Pork","(Salt)","-Diced-"],[1,"Large","Onion","(Finely Diced)"],[3,"Shallots","(Chopped)"],["2-4","Tablespoons","Butter","(Unsalted)"],[2,"Pound","Beef Chuck","(In 1-inch Cubes)"],[2,"Tablespoons","All-Purpose Flour"],"Kosher Salt","Black Pepper",["1/2","Cup","Cognac"],[2,"Cups","Beef Stock"],["1/2","Cup","Dijon Mustard"],[4,"Tablespoons","Pommery Mustard","(Or other Whole-grain Dijon Mustard)"],[4,"Large","Carrots","(Peeled and cut into half-moon slices)"],["1/2","Pound","Mushrooms","(Stemmed, Cleaned and Quartered)"],["1/4","Cup","Red Wine"]
],
steps: [
"Place salt pork in a Dutch oven over low heat, and cook until fat is rendered. Remove solid pieces with a slotted spoon, and discard. Raise heat, and add onion and shallots. Cook until softened but not browned, 10 to 15 minutes. Use a slotted spoon to transfer to a large bowl.","If necessary, add 2 tablespoons butter to the pot to augment fat. Dust beef cubes with flour, and season with salt and pepper. Shake off excess flour, and place half the cubes in the pot. Cook over medium-high heat until well browned, almost crusty, on all sides, then transfer to a bowl with onions. Repeat with remaining beef.","Add Cognac to the empty pot, and cook, stirring, until the bottom is deglazed and the crust comes loose. Add stock, Dijon mustard and 1 tablespoon Pommery mustard. Whisk to blend, then return meat and onion mixture to pot. Lower heat, partly cover, and simmer gently until meat is very tender, about 1 1/2 hours.","Add carrots, and continue simmering for 30 minutes, or until slices are tender. As they cook, heat 2 tablespoons butter in a medium skillet over medium-high, and sauté mushrooms until browned.","Stir mushrooms into stew along with remaining mustard and red wine. Simmer 5 minutes, then taste, and adjust seasoning. Serve hot."
]
},
{name: "Oliver's Chicken Stew", cat: "Stew", time: [1,"Hour"],
ingredients: [
["3½-4","Pound","Chicken","(Rinsed)"],[8,"Cups","Chicken Stock"],"Salt",["Black Pepper","(Freshly ground)"],[5,"Medium","Carrots","(Thickly sliced)"],[4,"Medium","Leeks","(Thickly sliced)","-Tender White Part Only-"],[4,"Celery","(Thickly sliced)","-Stalks-"],[4,"Cloves","Garlic","(Smashed)"],[1,"Teaspoon","Thyme","(Chopped)"],[1,"Bay Leaf"],[3,"Sprigs","Parsley","(Flat-Leaf)"],["1/2","Cup","Stellini","(Tiny Star Pasta)"],[3,"Tablespoons","Butter","(Unsalted)"],[1,"Tablespoon","Lemon Juice"],[1,"Tablespoon","Tarragon","(Chopped)"],["1/4","Cup","Parsley","(Chopped)","-Flat-Leaf-"],[6,"Slices","Bread","(Toasted, Italian)"],["1/4","Cup","Extra-Virgin Olive Oil"],["1/2","Cup","Parmesan Cheese","(Grated)"]
],
steps: [
"Place the chicken in a 6-quart pot, breast side down. Add the stock, lightly seasoned with salt and pepper, and bring to a boil, skimming often. Add the carrots, leeks, celery, garlic, thyme, bay leaf and parsley and simmer. After 15 minutes, flip the chicken and cook for 25 minutes more. Remove the chicken and let cool.","Discard the bay leaf and parsley. Strain the vegetables, reserving the vegetables and the liquid. Return the stock to the pot; bring to a simmer. Pull the chicken meat off the bones. Add the pasta to the stock and cook for 3 minutes, then whisk in the butter, lemon juice, tarragon and parsley. Add the chicken and vegetables; heat through.","To serve, place a piece of toast in the bottom of each of 6 bowls, then drizzle with olive oil and sprinkle with Parmesan. Top with stew."
]
},
{name: "Red Wine Chicken Stew", cat: "Stew", time: [30,"Minutes"],
ingredients: [
[8,"Medium","Chicken Thighs","(Bone-in, Skin removed)","-3 Pounds-"],[2,"Tablespoons","All-Purpose Flour"],["3/4","Teaspoon","Kosher Salt","(Plus more to taste)"],["1/2","Teaspoon","Black Pepper","(Freshly Ground)","-Plus more to taste)"],[4,"Tablespoons","Olive Oil","(Divided)"],[1,"Package","Pearl Onions","(Frozen, Thawed, Patted Dry)","-14-ounce-"],[2,"Cups",["Carrots","Parsnips"],"(A mix or either, Peeled, Diced)","-About 10 Ounces-"],[2,"Cups",["Celery Root","Rutabaga","Turnip"],"(A mix of either, Peeled, Large-diced)","-About 10 Ounces-"],[3,"Cloves","Garlic","(Minced)"],[1,"Tablespoon","Tomato Paste","(Plus 1 Teaspoon)"],[1,"Tablespoon","Thyme","(Fresh, Chopped)"],["3/2","Cups","Red Wine","(Dry)","-Such as Pinot Noir or Merlot-"],[2,"Cups","Chicken Broth","(Low sodium)"],[1,"Bay Leaf"],[2,"Teaspoons","Red Wine Vinegar"],["Parsley","(Fresh, Flat-Leaf)","-For Garnish (Optional)-"]
],
steps: [
"In a large bowl, combine the chicken with the flour and 1/4 teaspoon each of the salt and pepper, and toss to coat evenly. In a large, heavy pot such as a Dutch oven, over medium-high heat, heat 2 tablespoons of the oil until shimmering. Add half of the chicken and cook until golden on both sides, about 3 minutes per side, then transfer to a plate. Repeat with the remaining chicken.","Add the remaining oil to the empty pot, followed by the onions and the diced vegetables and cook, stirring occasionally, softened slightly, about 4 minutes. Add the garlic and cook for 30 seconds more, then stir in the tomato paste and thyme. Add the wine, bring to a boil and cook, uncovered, for about 2 minutes. Add the broth, bay leaf and the remaining 1/2 teaspoon salt and 1/4 teaspoon pepper and return to a boil.","Return the chicken, along with any accumulated juices, to the pot. Reduce the heat to medium-low, cover, and simmer until the chicken is cooked through and the vegetables are tender, about 25 minutes. Using a slotted spoon, transfer the chicken and vegetables to a rimmed serving plate and tent with foil. Increase the heat to high and cook until the sauce is reduced to about 2 cups, 5 to 10 minutes. Discard the bay leaf, then stir in the vinegar, and season to taste with additional salt and pepper, if desired. Pour the sauce over the chicken and vegetables, garnish with the parsley and serve."
]
},
{name: "Hungarian Mushroom Soup", cat: "Soup", time: [30,"Minutes"],
ingredients: [
[4,"Tablespoons","Butter"],[2,"Cups","Onions","(Chopped)"],[1,"Pound","Mushrooms","(Sliced)"],[2,"Cups",["Chicken Stock","Vegetable Stock"]],["1/2","Cup","White Wine","(Dry)"],[2,"Teaspoon","Dill","(Dried)"],[2,"Teaspoon","Thyme Leaves","(Fresh, Minced)"],[2,"Teaspoon","Paprika"],[2,"Tablespoon","Soy Sauce"],[1,"Cup","Milk"],[3,"Tablespoon","Flour"],["1/4","Cup","Sour Cream"],[2,"Tablespoon","Lemon Juice"],[2,"Tablespoon","Parsley","(Fresh, Italian)"]
],
steps: [
"In a heavy pot or dutch oven sauté onions and mushrooms in butter over medium heat until onions are soft and translucent, about 15 minutes. Add dill, thyme, paprika, chicken broth, soy sauce and white wine. Bring to a simmer and cook until the liquid reduces by half. In a small bowl, whisk flour into milk until smooth. Add the milk mixture to the soup and cook until the soup begins to thicken, about 10 more minutes.","Over low heat, slowly stir in the sour cream, and lemon juice until both are completely combined. Garnish the soup with parsley and serve hot."
]
},
{name: "Homemade Ramen", cat: "Soup", time: [30,"Minutes"],
ingredients: [
[2,"Large","Eggs"],[1,"Tablespoon","Olive Oil"],[4,"Cloves","Garlic","(Minced)"],[1,"Tablespoon","Ginger","(Grated)"],[4,"Cups","Chicken Broth","(Reduced Sodium)"],[4,"Ounces","Shiitake Mushrooms"],[1,"Tablespoon","Soy Sauce","(Reduced Sodium)"],[3,"Packages","Yaki-Soba","(Refrigerated, (5.6oz))","-Seasoning sauce packets discarded-"],[3,"Cups","Baby Spinach"],[8,"Slices","Narutomaki","(Optional)"],[1,"Carrots","(Grated)"],[2,"Tablespoons","Chives","(Chopped)"]
],
steps: [
...
{name: "Broccolini (or Asparagus) and Carrots", cat: "Greens",
ingredients: [
["1/3","Cup","Chicken Broth"],[2,"Teaspoons","Soy Sauce"],[1,"Teaspoon","Corn Starch"],[1,"Teaspoon","Vegetable Oil"],["1/2","Pound",["Broccoli","Asparagus"]],["1/2","Carrots","(Thinly Sliced)"]
],
steps: [
"In a small bowl, combine the broth, soy sauce, and corn starch, stirring to dissolve.","In a large, nonstick skillet over high heat, heat the oil. Sauté green vegetables until bright green (about 2 minutes). Add the broth mixture and carrots. Cook, stirring constantly until vegetables are tender and sauce is thickened (about 3 minutes)."
]
},
{name: "Smashed Potatoes", cat: "Greens",
ingredients: [
[2,"Medium","Potatoes"],"Butter","Half And Half","Garlic Powder","Dill","Salt","Pepper"
],
steps: [ "Smash?" ]
},
{name: "Mashed Potaotes", cat: "Greens",
ingredients: [
["4-5","Potatoes","(Peeled and Diced into ½-inch Cubes)","-Idaho-"],[1,"Tablespoon","Butter"],["3/2","Cup","Heavy Cream"],[2,"Pinches","Salt"],[1,"Pinch","Black Pepper"]
],
steps: [
"Boil potatoes until tender (about 15 minutes).","Drain.","Combine potatoes with butter, cream, salt and pepper in large bowl. Mix or mash to an even but not too fine cosistency. Bake in large oven-proof Casserole for about 15 minutes at 350 degrees until golden brown."
]
},
{name: "Roasted Potatoes, Carrots, Parsnips and Brussel Sprouts", cat: "Greens", time: [1,"Hour"],
ingredients: [
["1/3","Cup","Extra-Virgin Olive Oil"],[3,"Medium","Carrots","(Cut into 1½-inch Thick Circles)","-About 3/4 Pound-"],["3/2","Cups","Brussels Sprouts","(Halved)","-About 1/2 Pound-"],[4,"Cups","Red Bliss Potatoes","(Cut into 1½-inch Thick Slices)","-About 1 Pound-"],[3,"Medium","Parsnips","(Cut into 1½-inch Thick Slices)","-About 1 Pound-"],[1,"Cup","Sweet Potatoes","(Cut into 1½-inch Thick Slices)","-About 1 Pound-"],[1,"Tablespoon","Oregano","(Dried)"],[1,"Tablespoon","Rosemary","(Dried)"],[1,"Teaspoon","Thyme","(Dried)"],[1,"Teaspoon","Basil","(Dried)"],["1/4","Teaspoon","Sea Salt"],[1,"Teaspoon","Black Pepper","(Freshly Ground)"]
],
steps: [
